...
const HeroSection = () => {
    return (
    <section className="wrapper mb-10 mb:mb-16">
        <div className="library-hero-card">
            ...
            <div className="library-hero-text">
                ...
                <p className="library-hero-description">
                    Ubahlah bukumu menjadi AI interaktiv. <br className="hiddem md:block"/>
                    Mendengar, belajar, dan diskusi tentang buku favoritmu
                </p>
                        ...
                        <div className="w-10 h-10 min-w-10 min-h-10 rounded-full border border-gray-300 flex items-center justify-center font-medium text-lg">1</div>
                                    ...
                                    <li className="library-step-item">
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <p className="library-step-description text-gray-500">Menganalisis buku yang diberikan</p>
                                        </div>
                                    </li>
                                    <li className="library-step-item">
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <p className="library-step-description text-gray-500">Diskusi bersama AI</p>
                        </div>
                    </li>
                </ul>
            </div>
