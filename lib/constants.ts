...
export const ACCEPTED_PDF_TYPES = ['application/pdf', 'application/x-pdf', 'application/octet-stream'];
export const ACCEPTED_PDF_INPUT_TYPES = [...ACCEPTED_PDF_TYPES, '.pdf'];
